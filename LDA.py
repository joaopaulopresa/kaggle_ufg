from util import load_train_data, text_process3, load_test_resp
...
def plot_10_most_common_words(count_data, count_vectorizer):
    ...
    count_dict = sorted(count_dict, key=lambda x:x[1], reverse=True)[10:20]
...
#print(train_df.head())
train_df = load_test_resp()
train_df = text_process3(train_df)
print(train_df.shape)
train_df = train_df[train_df['category'] == 'erro']
